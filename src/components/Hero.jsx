    ...
    return (
        <div className='max-w-[1640px] mx-auto p-4'>
            <div className='max-h-[500px] relative'>
                ...
                <img className='w-full max-h-[500px] object-cover' src="https://images.pexels.com/photos/13743427/pexels-photo-13743427.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" srcset="" />
            </div>
        </div >
    )
}
